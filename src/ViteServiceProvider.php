...
use Irujimee\Vite\Commands\ExportConfigurationCommand;
use Irujimee\Vite\Commands\UpdateTsconfigCommand;
use Irujimee\Vite\EntrypointsFinder\DefaultEntrypointsFinder;
use Irujimee\Vite\EntrypointsFinder\EntrypointsFinder;
use Irujimee\Vite\HeartbeatCheckers\HeartbeatChecker;
use Irujimee\Vite\HeartbeatCheckers\HttpHeartbeatChecker;
use Irujimee\Vite\TagGenerators\CallbackTagGenerator;
use Irujimee\Vite\TagGenerators\TagGenerator;
...
class ViteServiceProvider extends PackageServiceProvider
{
    ...
    protected function registerAbout()
    {
        ...
        AboutCommand::add('Vite', [
            'Version' => InstalledVersions::getPrettyVersion('Irujimee/lavi-plugin'),
